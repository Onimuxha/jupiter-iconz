...
<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#cursorWhite_clip1)">
    <rect width="512" height="512" rx="122" fill="#000" />
    <g clip-path="url(#cursorWhite_clip2)">
      <mask id="cursorWhite_mask" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="85" y="89" width="343" height="334">
        <path d="M85 89h343v334H85V89z" fill="#fff" />
      </mask>
      <g mask="url(#cursorWhite_mask)">
        <path d="M255.428 423l148.991-83.5L255.428 256l-148.99 83.5 148.99 83.5z"
              fill="url(#cursorWhite_grad0)" />
        <path d="M404.419 339.5v-167L255.428 89v167l148.991 83.5z"
              fill="url(#cursorWhite_grad1)" />
        <path d="M255.428 89l-148.99 83.5v167l148.99-83.5V89z"
              fill="url(#cursorWhite_grad2)" />
  ...
  <defs>
    <linearGradient id="cursorWhite_grad0" x1="255.428" y1="256" x2="255.428" y2="423" gradientUnits="userSpaceOnUse">
      <stop offset=".16" stop-color="#fff" stop-opacity=".39" />
      <stop offset=".658" stop-color="#fff" stop-opacity=".8" />
    </linearGradient>
    <linearGradient id="cursorWhite_grad1" x1="404.419" y1="173.015" x2="257.482" y2="261.497" gradientUnits="userSpaceOnUse">
      <stop offset=".182" stop-color="#fff" stop-opacity=".31" />
      <stop offset=".715" stop-color="#fff" stop-opacity="0" />
    </linearGradient>
    <linearGradient id="cursorWhite_grad2" x1="255.428" y1="89" x2="112.292" y2="342.802" gradientUnits="userSpaceOnUse">
      <stop stop-color="#fff" stop-opacity=".6" />
      <stop offset=".667" stop-color="#fff" stop-opacity=".22" />
    </linearGradient>
    <clipPath id="cursorWhite_clip1">
      <path fill="#fff" d="M0 0h512v512H0z" />
    </clipPath>
    <clipPath id="cursorWhite_clip2">
...
<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#klingLogo_clip0)">
        <g clip-path="url(#klingLogo_clip1)">
            <path
                ...
                fill="url(#klingLogo_paint0_radial)" />
            <path
                ...
                fill="url(#klingLogo_paint1_radial)" />
            <path
                ...
                fill="url(#klingLogo_paint2_linear)" />
            <path
                ...
                fill="url(#klingLogo_paint3_linear)" />
        </g>
    </g>
    <defs>
        <radialGradient id="klingLogo_paint0_radial" cx="0" cy="0" r="1"
        ...
        <radialGradient id="klingLogo_paint1_radial" cx="0" cy="0" r="1"
            gradientUnits="userSpaceOnUse"
        ...
        <linearGradient id="klingLogo_paint2_linear" x1="332.331" y1="38.357" x2="385.323"
            y2="210.368"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="#003EFF" />
            <stop offset="1" stop-color="#0BFFE7" />
        </linearGradient>
        <linearGradient id="klingLogo_paint3_linear" x1="179.669" y1="472.363" x2="126.677"
            y2="300.352"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="#003EFF" />
            <stop offset="1" stop-color="#0BFFE7" />
        </linearGradient>
        <clipPath id="klingLogo_clip0">
            <path fill="#fff" d="M0 0h512v512H0z" />
        </clipPath>
        <clipPath id="klingLogo_clip1">
            <path fill="#fff" d="M0 0h512v512H0z" />
        </clipPath>
    </defs>
</svg>
...
<svg viewBox="0 0 512 512">
    <path
        d="M170.797 103.091h271.066l3.868-17.216c5.633-26.718-14.568-51.964-41.874-51.964H140.505c-34.138 0-63.525 23.754-70.967 57.01L11.941 356.94c-5.634 26.718 14.546 51.964 41.874 51.964h16.039l58.775-271.97c4.456-19.591 21.967-33.844 42.168-33.844z"
        fill="#00cdfa" fill-rule="nonzero" />
    <path
        d="M23.5 4.417h-.763l-2.796 12.937a2.041 2.041 0 01-1.992 1.61H5.054l-.184.819a2.043 2.043 0 001.992 2.472H19.39a3.46 3.46 0 003.375-2.712l2.741-12.641A2.058 2.058 0 0023.5 4.417z"
        fill="url(#writesonic1)" fill-rule="nonzero"
        transform="matrix(21.02101 0 0 21.02101 -36.092 10.263)" />
    <path
        d="M383.067 375.061l58.796-271.949H170.797c-20.201 0-37.712 13.937-41.874 33.844l-58.775 271.95h271.066c20.18 0 37.417-14.253 41.853-33.845z"
        fill="#3a00ff" fill-rule="nonzero" />
    <path
        d="M158.331 305.124l-19.633-101.973h30.774l9.48 63.631 31.091-63.63h20.727l12.15 63.63 28.525-63.63h30.775L252.4 305.123h-25.75l-12.256-59.741-29.997 59.741h-26.066zM291.415 288.623l16.06-18.604c7.232 8.913 16.376 13.475 27.643 13.475 7.231 0 13.58-3.006 14.589-8.01.336-3.026-1.682-5.57-6.349-7.82-1.114-.546-3.573-1.429-7.462-2.774-7.694-3.006-11.036-4.12-17.72-8.366-9.376-5.781-13.833-13.811-12.277-27.643 3.027-18.835 20.285-29.303 42.126-29.303 14.946 0 27.201 4.898 37.123 14.588l-15.829 18.52c-6.58-6.138-14.147-9.144-22.724-9.144-6.915 0-11.036 1.997-11.94 6.348-.777 3.574 1.115 6.58 5.571 8.577 1.45.778 4.478 2.018 8.934 3.678 4.456 1.682 8.24 3.133 11.351 4.92 10.048 4.225 21.862 14.146 18.289 29.303-1.682 9.922-6.685 17.72-15.156 23.29-8.367 5.571-18.499 8.367-29.871 8.367-18.289-.105-32.436-6.474-42.358-19.402z"
        fill="#fff" fill-rule="nonzero" />
    <defs>
        <linearGradient id="writesonic1" x1="0" y1="0" x2="1" y2="0"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(4.825 13.338) scale(20.7201)">
...
<svg viewBox="0 0 512 512">
    <path
        ...
        fill="url(#meta-ai-vector)" transform="scale(21.33334)" />
    <defs>
        <linearGradient id="meta-ai-vector" x1="0" y1="0" x2="1" y2="0"
...
<svg viewBox="0 0 512 512"
    clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2">
    <path
        d="M363.414 85.141c58.666 0 106.24 47.787 106.24 106.731v35.563l30.933 61.781c3.05 6.101 3.05 13.312-.043 19.392l-30.89 61.099v35.584c0 58.923-47.574 106.71-106.24 106.71H150.912c-58.688 0-106.24-47.787-106.24-106.71v-35.584L13.099 308.8a21.57 21.57 0 01-.064-19.776l31.616-61.59v-35.562c0-58.944 47.573-106.73 106.24-106.73h212.523zM176.32 204.801c-26.603 0-48.512 21.908-48.512 48.511v86.23c.555 26.218 22.272 47.488 48.512 47.488 26.219 0 47.936-21.27 48.49-47.488v-86.23c0-26.603-21.887-48.49-48.49-48.512zm156.288 0c-26.603 0-48.512 21.908-48.512 48.511v86.23c0 26.602 21.91 48.512 48.512 48.512 26.603 0 48.512-21.91 48.512-48.512v-86.23c0-26.603-21.91-48.512-48.512-48.512h-.021.021z"
        fill="#383e45" />
    <path
        d="M257.152 118.57c32.533 0 59.285-26.751 59.285-59.285C316.437 26.752 289.685 0 257.152 0s-59.285 26.752-59.285 59.285c0 32.534 26.752 59.286 59.285 59.286z"
        fill="#383e45" />
</svg>
`.trim(),
  },
...
<svg viewBox="0 0 512 512">
    <g clip-path="url(#deep-ai)">
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M492.392 363.954c.363-.725.725-1.472.725-2.197 2.88-7.403 5.76-16.278 7.211-23.68 18.773-66.56 20.224-152.32-47.616-244.01-1.707-1.75-2.88-3.478-3.883-4.907-.704-1.025-1.28-1.878-1.898-2.496 17.322-13.313 38.976-17.75 54.848-17.75 8.661 0 12.992-10.346 7.21-16.277-56.277-62.102-118.336-60.63-161.642-36.97-70.699-26.625-147.2-17.75-193.387 14.804-79.36 54.72-79.36 116.822-38.955 174.507a166.71 166.71 0 00-15.872 44.373c-2.901 14.784 14.422 25.131 24.534 14.784 20.202-19.221 46.186-42.88 59.157-51.754 31.765-23.68 51.968-32.555 80.832-36.971h1.429c10.112-1.493 18.774-2.965 28.864-2.965a165.649 165.649 0 01163.094 136.064l.426 3.584c1.28 10.389 2.454 19.818 2.454 30.421v7.403l-4.331-13.312c-17.323-34.006-50.496-59.158-90.923-59.158 0 10.368 0 22.187-1.429 32.534-5.781 56.213-38.976 100.586-83.712 125.717-1.451 0-1.451 1.493-2.88 1.493-4.331 1.472-10.112 4.416-14.443 5.91a24.592 24.592 0 01-3.605 1.493 24.367 24.367 0 00-3.627 1.451 122.436 122.436 0 01-46.165 8.874h-8.661c-10.091 0-21.654 0-31.744-2.965-23.104-4.416-43.307-14.784-60.63-28.096-10.09-7.381-18.752-16.256-27.413-26.603 37.547 59.158 99.584 102.038 173.184 112.384a183.55 183.55 0 0049.067 1.494 387.159 387.159 0 0040.405-7.403 162.445 162.445 0 0037.547-13.312c10.09-4.437 18.752-8.875 27.413-14.784 0 0 .491-.512 1.195-.939.511-.326 1.1-.51 1.706-.533 2.859-2.987 7.19-4.437 10.091-7.403 6.656-5.461 12.075-10.922 17.408-16.362l-.107.106c4.331-4.458 7.232-8.896 11.563-13.333 7.168-8.811 14.336-19.115 21.525-29.397l.107-.171c7.232-13.312 14.443-26.624 20.203-41.408 0-.747.362-1.493.725-2.219v-.021zM64.509 309.981v65.066H1v-65.066h63.51z"
            fill="#000" />
    </g>
</svg>
`.trim(),
...
<svg viewBox="0 0 512 512">
    <g>
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M352 0c88.363 0 160 114.624 160 256H320c0 141.376-71.637 256-160 256S0 397.376 0 256h192C192 114.624 263.637 0 352 0z"
            fill="#000" />
    </g>
</svg>
`.trim(),
...
<svg viewBox="0 0 512 512">
    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        fill="url(#lovable-bg)" />
    <defs>
        <radialGradient id="lovable-bg" cx="0" cy="0" r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="rotate(92.545 118.724 174.844) scale(480.474 650.325)">
            <stop offset=".25" stop-color="#FE7B02" />
            <stop offset=".433" stop-color="#FE4230" />
            <stop offset=".548" stop-color="#FE529A" />
            <stop offset=".654" stop-color="#DD67EE" />
...
<svg viewBox="0 0 512 512">
    <g transform="scale(32)">
        <g clip-path="url(#pika)">
            <path
                d="M.44 13.26h5.778c-.093-.94-.763-1.97-2.4-2.672v-.07c1.908.587 2.595 1.591 2.874 2.74h7.128l-1.147-.983C13.345 10.163 16 9.165 16 9.165c-.094-1.694-.96-3.273-3.858-4.552L5.551 2c.22 2.786 1.207 4.383 3.682 4.775v.068c-1.72-.042-2.912-.81-3.517-2.392C.466 5.415-.801 9.437.44 13.26z" />
        </g>
    </g>
</svg>
`.trim(),
